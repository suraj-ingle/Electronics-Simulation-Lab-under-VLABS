...
/*this.context.arc(this.x1+115,this.y1-25,5,0,2*Math.PI,true);//circle 1
        this.context.stroke();
        
        this.context.beginPath();
        this.context.arc(this.x2+114,this.y2-25,5,0,2*Math.PI,true);//circle 2
        this.context.stroke();
        this.context.beginPath();
        this.context.arc(this.x3+110,this.y3-25,5,0,2*Math.PI,true);//circle 3s
        this.context.stroke(); */
...
var myConnection=function(canvas,x1,y1,x2,y2,componentType)
{
        this.canvas = canvas;
        this.context = this.canvas.getContext("2d");
        this.x = [];
	...
	this.x[3] = x2;
	this.y[3] = y2;
	this.x[1] = (this.x[0]+this.x[3])/2;
        this.y[1] = y1;
        this.x[2] = (this.x[0]+this.x[3])/2;
        this.y[2] = y2;
...
myConnection.prototype.drawline=function()
{
        ...
        this.context.beginPath();
        this.context.moveTo(this.newx[0], this.newy[0]);
        for(var i = 1;i<this.newx.length;i++)      {
                this.context.lineTo(this.newx[i], this.newy[i]);
...
r11.prototype.draw=function()  	/////////////////////////////////////////////////////// R1
{
        ...
        this.context.fillText(this.lable,x+55,y-20);
        this.context.fillText(this.value+" ohm",x+40,y+25);
        this.context.beginPath();
...
/*
        ...
        this.context.font = "15px Arial";
        this.context.fillText(this.lable,x+43,y-15);
        //this.context.fillText(this.value+" ohm",x+30,y+26)
...
this.context.fillStyle = "black"
this.context.font = "15px Arial";
this.context.fillText("+" + this.value,x+20,y + 90);
this.context.fillText("-" + this.value,x+20,y - 20);
this.context.stroke();
...
var x=this.x;
       ...
       this.context.beginPath();
        ...
        this.context.font = "15px Arial";
        this.context.fillText("GND",this.x2+25,this.y2+20);
        this.context.stroke();
...
cro.prototype.draw=function()
{
        ...
        this.context.fillText(this.value, this.x5+30,this.y5+93);
        this.context.fill();
        this.context.font = "12px Georgia";
        this.context.fillStyle = "red";
        this.context.align="center";
        this.context.fillText("o/p     ", this.x5+123,this.y5+71);
        this.context.fillStyle = "green";
        this.context.fillText( "        G   ", this.x5+147,this.y5+71);
        this.context.fillStyle = "black";
        this.context.fillText("     i/p", this.x5+133,this.y5+71);
        this.context.fill();
        ...
        this.context.fillStyle= "black";
        this.context.fillText("CLICK",this.x4+1,this.y4+16);
        this.context.fill();
        
        this.context.rect(this.x4,this.y4,43,20);
